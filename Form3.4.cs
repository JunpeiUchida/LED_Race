...
namespace LED_Race
{
    public partial class game2_intro : Form
    {
        // ゲーム説明画面4
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            file2.WriteLine(string.Format("{0}, {1}", dt.ToString("yyyyMMddHHmmss"), "F3.4_button1_Click"));
            file2.Close();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if(time == 10)
            {
                ...
                StreamWriter file2 = new StreamWriter(filename2, true, Encoding.UTF8);
                file2.WriteLine(string.Format("{0}, {1}", dt.ToString("yyyyMMddHHmmss"), "F3.4_time == 4"));
                file2.Close();
            ...
            if (time > 180)
            {
                ...
                StreamWriter file2 = new StreamWriter(filename2, true, Encoding.UTF8);
                file2.WriteLine(string.Format("{0}, {1}", dt.ToString("yyyyMMddHHmmss"), "F3.4_time == 180"));
                file2.Close();
        ...
        private void button53_Click(object sender, EventArgs e)
        {
            ...
            StreamWriter file2 = new StreamWriter(filename2, true, Encoding.UTF8);
            file2.WriteLine(string.Format("{0}, {1}", dt.ToString("yyyyMMddHHmmss"), "F3.4_button53_Click"));
            file2.Close();
        ...
        private void game2_intro_FormClosing(object sender, FormClosingEventArgs e)
        {
            // txtファイルの書き込み
            DateTime dt = DateTime.Now;
            string filename2 = @"log_" + dt.ToString("yyyyMMdd") + ".txt";
            ...
            StreamWriter file2 = new StreamWriter(filename2, true, Encoding.UTF8);
            file2.WriteLine(string.Format("{0}, {1}", dt.ToString("yyyyMMddHHmmss"), "F3.4_close"));
